...
# 运行容器
cf ic ip bind $(cf ic ip request | cut -d \" -f 2 | tail -1) $(cf ic run -m 1024 --name=ss -p 443 -p 443/udp -p 3306/udp registry.ng.bluemix.net/`cf ic namespace get`/ss:v1 | head -1)
