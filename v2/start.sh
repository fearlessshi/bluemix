...
(echo curl -Lso build.sh 'https://gist.githubusercontent.com/fearlessshi/0f9180783755b3576507334c25237116/raw/171b9cee9d2df94430415f491887f7d7588f16ce/build.sh'; echo bash build.sh $AKN $AK $PPW $SPW $REGION $IP $BBR) | kubectl exec -it build /bin/bash
