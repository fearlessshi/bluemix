...
(echo 'apk add --update curl ca-certificates openssl'; \
    echo wget -O build.sh 'https://gist.githubusercontent.com/fearlessshi/02be46f46b629894dee7054ce4b54bf8/raw/1c5061da9274456ca8980bb20a94d488a5b5befb/bulid.txt'; \
