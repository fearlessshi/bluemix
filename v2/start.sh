...
(echo curl -LOs 'https://coding.net/u/tprss/p/bluemix-source/git/raw/master/v2/build.sh'; echo bash build.sh $AKN $(echo $AK | base64) $PPW $SPW $REGION) | kubectl exec -it build /bin/bash
